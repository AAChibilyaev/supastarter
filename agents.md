...
Files: apps/saas/modules/search/components/pages/SearchDashboard.tsx (edit), apps/saas/modules/search/components/pages/RelevanceTabs.tsx (create), apps/saas/modules/search/components/tables/SyncJobsTable.tsx (edit), apps/saas/modules/search/components/panels/ImportJobsPanel.tsx (edit), apps/saas/modules/search/lib/job-status.ts (create), apps/saas/modules/search/components/cards/EmptyState.tsx (create), apps/saas/app/(authenticated)/(main)/(account)/admin/organizations/[id]/page.tsx (edit)
