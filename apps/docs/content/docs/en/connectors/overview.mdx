...
The PrestaShop and Bitrix modules are tracked separately from the main Node.js monorepo. They are functional skeletons — the core sync and auth flows work, but installation packaging and admin UI polish are still in progress.
