...
> **Important**: Changing the region updates the routing target for _new_ data only. Existing search data remains in the original region until you run a data migration.
