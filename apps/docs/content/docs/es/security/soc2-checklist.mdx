...
<Callout type="info">
	**Período de auditoría objetivo:** 6–12 meses de recopilación de evidencia. Cada elemento debe
	ser verificable a través de registros generados por el sistema, instantáneas de configuración o
