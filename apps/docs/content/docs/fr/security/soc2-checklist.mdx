...
<Callout type="info">
	**Période d'audit cible :** 6–12 mois de collecte de preuves. Chaque élément doit être
	vérifiable via des journaux générés par le système, des instantanés de configuration ou des
