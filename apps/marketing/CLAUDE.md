...
## Project DNA: marketing

Stack: Next.js 16.2.2, React catalog:, TypeScript, Tailwind CSS
Style: [unknown]
Structure: .content-collections, .turbo, app, content, modules, public, tests
Deploy: [NOT SET]
Active: [new session]
Last: [first session]
...
Files: content/posts/zero-downtime-reindexing.fr.mdx (create), content/posts/typesense-vs-elasticsearch-ecommerce.fr.mdx (create), content/posts/prestashop-search-integration.fr.mdx (create), content/posts/zero-downtime-reindexing.es.mdx (create), content/posts/typesense-vs-elasticsearch-ecommerce.es.mdx (create), content/posts/prestashop-search-integration.es.mdx (create), content/posts/zero-downtime-reindexing.de.mdx (create), content/posts/typesense-vs-elasticsearch-ecommerce.de.mdx (create), /Users/aac/Projects/ts/supastarter/apps/saas/modules/search/components/panels/ImportJobsPanel.tsx (edit)
