...
import { ConnectorsOverview } from "../../../modules/connectors/components/ConnectorsOverview";

export async function generateMetadata(props: {
	params: Promise<{ locale: string }>;
}): Promise<Metadata> {
	const { locale } = await props.params;
	const t = await getTranslations({ locale, namespace: "connectorsPage" });
	return {
		title: t("title"),
...
export default async function ConnectorsPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
