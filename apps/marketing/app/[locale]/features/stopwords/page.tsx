...
import { StopwordsGrid } from "../../../../modules/features/components/StopwordsGrid";
...
export default async function FeaturesStopwordsPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
