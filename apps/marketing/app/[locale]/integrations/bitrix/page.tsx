...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
	...
	const t = await getTranslations({ locale, namespace: "integrationsBitrixPage" });
	return {
		title: t("title"),
...
export default async function IntegrationsBitrixPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
