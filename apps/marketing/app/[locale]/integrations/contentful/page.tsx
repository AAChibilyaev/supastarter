...
export async function generateMetadata(props: { params: Promise<{ locale: string }> }): Promise<Metadata> {
	...
	const t = await getTranslations({ locale, namespace: "integrationsContentfulPage" });
	return {
		title: t("title"),
...
export default async function IntegrationsContentfulPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
