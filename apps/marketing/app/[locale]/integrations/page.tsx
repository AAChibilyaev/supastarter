...
import { IntegrationsGrid } from "../../../modules/integrations/components/IntegrationsGrid";
...
export default async function IntegrationsPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
