...
import { NewsletterGrid } from "../../../modules/newsletter/components/NewsletterGrid";
...
export default async function NewsletterPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
