...
import { OpenSourceGrid } from "../../../modules/open-source/components/OpenSourceGrid";
...
export default async function OpenSourcePage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
