...
import { SolutionsEducationGrid } from "../../../../modules/solutions/components/SolutionsEducationGrid";
...
export default async function SolutionsEducationPage(props: { params: Promise<{ locale: string }> }) {
	const { locale } = await props.params;
