...
Sanity.io is the programmable CMS — built for structured content, real-time collaboration, and custom editing experiences. With GROQ (GROQ Query Language), Sanity gives you SQL-like querying over your content. But like any CMS, Sanity is a content _management_ platform, not a search engine. For customer-facing search with typo tolerance, faceting, and relevance ranking, you need AACsearch.
...
_AACsearch Sanity.io connector is in development. [Get early access](https://aacsearch.com) to be notified when it launches._
