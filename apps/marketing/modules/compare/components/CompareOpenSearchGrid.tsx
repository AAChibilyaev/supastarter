...
const items: CompareOpenSearchGridItem[] = [
	{ key: "complexity", icon: AlertTriangleIcon },
...
const spanMap: Record<CompareOpenSearchGridItem["key"], string> = {
...
export function CompareOpenSearchGrid() {
	const t = useTranslations("compareOpenSearch");
