...
const items: ComparePineconeGridItem[] = [
	{ key: "keywordSearch", icon: SearchIcon },
	{ key: "facets", icon: SlidersHorizontalIcon },
	{ key: "hybridSearch", icon: LayersIcon },
	{ key: "pricing", icon: CreditCardIcon },
	{ key: "performance", icon: ZapIcon },
	{ key: "widget", icon: LayoutIcon },
];

const spanMap: Record<ComparePineconeGridItem["key"], string> = {
	keywordSearch: "md:col-span-2",
	facets: "md:col-span-1",
	hybridSearch: "md:col-span-1",
	pricing: "md:col-span-1",
	performance: "md:col-span-1",
	widget: "md:col-span-2",
};

export function ComparePineconeGrid() {
	const t = useTranslations("comparePinecone");
