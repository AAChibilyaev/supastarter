...
const items: CompareWeaviateGridItem[] = [
	{ key: "hybridSearch", icon: SearchIcon },
	{ key: "facets", icon: SlidersHorizontalIcon },
	{ key: "typoTolerance", icon: CheckCircleIcon },
	{ key: "multiTenancy", icon: UsersIcon },
	{ key: "pricing", icon: CreditCardIcon },
	{ key: "widget", icon: LayoutIcon },
];

const spanMap: Record<CompareWeaviateGridItem["key"], string> = {
	hybridSearch: "md:col-span-2",
	facets: "md:col-span-1",
	typoTolerance: "md:col-span-1",
	multiTenancy: "md:col-span-1",
	pricing: "md:col-span-1",
	widget: "md:col-span-2",
};

export function CompareWeaviateGrid() {
	const t = useTranslations("compareWeaviate");
