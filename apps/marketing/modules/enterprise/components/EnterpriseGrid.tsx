...
const items: EnterpriseItem[] = [
	{ key: "sso", icon: KeySquareIcon },
	{ key: "dedicatedCluster", icon: ServerIcon },
	{ key: "auditLog", icon: ScrollTextIcon },
	{ key: "sla", icon: ShieldCheckIcon },
	{ key: "prioritySupport", icon: HeadphonesIcon },
	{ key: "customIntegrations", icon: ZapIcon },
];

const spanMap: Record<EnterpriseItem["key"], string> = {
	sso: "md:col-span-2",
	dedicatedCluster: "md:col-span-1",
	auditLog: "md:col-span-1",
	sla: "md:col-span-1",
	prioritySupport: "md:col-span-1",
	customIntegrations: "md:col-span-2",
};
