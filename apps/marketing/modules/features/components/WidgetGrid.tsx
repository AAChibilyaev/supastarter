...
interface WidgetItem {
	key: "shadowDom" | "noFramework" | "i18n" | "analytics" | "config" | "performance";
	icon: ComponentType<{ className?: string }>;
}

const items: WidgetItem[] = [
	{ key: "shadowDom", icon: LayersIcon },
	{ key: "noFramework", icon: CodeIcon },
	{ key: "i18n", icon: LanguagesIcon },
	{ key: "analytics", icon: BarChartIcon },
	{ key: "config", icon: SlidersIcon },
	{ key: "performance", icon: ZapIcon },
];

const spanMap: Record<WidgetItem["key"], string> = {
	shadowDom: "md:col-span-2",
	noFramework: "md:col-span-1",
	i18n: "md:col-span-1",
	analytics: "md:col-span-1",
	config: "md:col-span-1",
	performance: "md:col-span-2",
};

export function WidgetGrid() {
	const t = useTranslations("featuresWidget");
