			...
			<div className="container">
				<div className="max-w-3xl mx-auto text-center">
					...
					<p className="mt-4 text-lg font-light text-balance text-muted-foreground">
						Snap a photo to find similar products. Upload a reference image or screenshot
						to find matching assets, docs, or designs.
					</p>
				</div>
				...
				<div className="mt-12 md:mt-16 max-w-3xl mx-auto">
					<h3 className="text-center text-lg font-light text-foreground mb-6">
