...
const items: IntegrationsStrapiItem[] = [
...
const spanMap: Record<IntegrationsStrapiItem["key"], string> = {
...
export function IntegrationsStrapiGrid() {
	const t = useTranslations("integrationsStrapi");
