	...
	return (
		<TooltipProvider delayDuration={0}>
			...
			>
				{/* Active indicator */}
				<div
					className="left-0.5 top-0.5 h-7 w-7 shadow-sm ease-in-out pointer-events-none absolute rounded-full border border-border bg-background transition-transform duration-200"
					style={{
