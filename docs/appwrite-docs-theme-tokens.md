...
--color-offset: hsl(var(--color-greyscale-hue) 2% 11% / .94);
```
...
.dark .web-u-only-dark { display: block; }
.light .web-u-only-dark { display: none; }
.light .web-u-only-light { display: block; }

/* Dark-specific overrides */
.dark\:bg-greyscale-900:where(.dark, .dark *) { background-color: var(--color-greyscale-900); }
.dark\:text-greyscale-100:where(.dark, .dark *) { color: var(--color-greyscale-100); }
.dark\:border-white\/10:where(.dark, .dark *) { border-color: #ffffff1a; }
.dark\:bg-white\/\[0\.04\]:where(.dark, .dark *) { background-color: #ffffff0a; }
.dark\:bg-white\/\[0\.12\]:where(.dark, .dark *) { background-color: #ffffff1f; }
```
