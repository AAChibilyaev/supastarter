    ...
    var aacsearch = {
        ...
        testConnection: function () {
            ...
            statusEl
                ...
                .addClass('')
                .text(aacsearchAdmin.i18n.testing);

            $.post(aacsearchAdmin.ajaxUrl, {
                ...
                statusEl
                    .addClass('error')
                    .text(aacsearchAdmin.i18n.testFailed);
            });
        },
        ...
        runReindex: function () {
            ...
            statusEl
                .removeClass('success error')
                .text(aacsearchAdmin.i18n.reindexing);
            ...
            $.post(aacsearchAdmin.ajaxUrl, {
                ...
                if (response.success) {
                    ...
                    statusEl
                        .addClass('error')
                        .text((response.message) || aacsearchAdmin.i18n.error + ' ' + aacsearchAdmin.i18n.reindexFailed);
                }
            }).always(function () {
