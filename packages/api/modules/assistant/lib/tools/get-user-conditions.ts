...
const inputSchema = z.object({
	productId: z.string().optional().describe("Product ID to check category-specific discounts for"),
	categoryId: z.string().optional().describe("Category ID to check category-specific discounts for"),
});

export function createGetUserConditionsTool(loyaltyConnector: LoyaltyConnector, sessionUserId?: string) {
	return tool({
		description:
