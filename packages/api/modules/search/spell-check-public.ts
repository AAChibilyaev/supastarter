import { SymSpell, detectLanguage, fixKeyboardLayout, fixCapsLock, normalize, normalizeYo, transliterate } from "@repo/nlp";
...
const COMMON_EN = [
	...
	"would", "could", "should", "there", "where", "search", "find", "query",
	"result", "index", "product", "price", "name", "title", "description",
	"category", "brand", "hello", "world", "test", "data", "user", "account",
];

const COMMON_RU = [
	"и", "в", "не", "на", "я", "он", "с", "что", "а", "по", "это", "она",
	"они", "мы", "как", "из", "у", "к", "от", "за", "так", "но", "его",
	"ее", "все", "или", "же", "то", "о", "для", "еще", "товар", "цена",
	"название", "описание", "категория", "бренд", "поиск", "результат",
	"запрос", "документ", "коллекция", "продукт", "имя", "привет", "мир",
	"тест", "данные", "пользователь", "админ", "ключ",
];
