							...
							"application/json": {
								schema: {
									...
									properties: {
										...
										curationTags: {
											type: "string",
											description: "Tags for curation results, comma-separated.",
										},
										hybridConfidence: {
											type: "number",
											minimum: 0,
								...
								schema: {
									...
									properties: {
										q: {
											...
											minLength: 1,
											maxLength: 200,
											description: "The search query prefix to get suggestions for",
										},
										limit: {
											type: "integer",
											minimum: 1,
										...
										fuzzy: {
											type: "boolean",
											default: true,
											description: "Enable fuzzy matching with typo tolerance",
										},
										fuzzyDistance: {
											type: "integer",
											minimum: 1,
										...
										minPrefix: {
											...
											maximum: 10,
											default: 2,
											description: "Minimum prefix length to trigger suggestions",
										},
										popular: {
											type: "boolean",
											default: true,
											description: "Include popular query suggestions from analytics",
										},
										trending: {
											type: "boolean",
											default: true,
