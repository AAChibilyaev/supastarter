								...
								schema: {
									...
									properties: {
										...
										mode: {
											...
											default: "auto",
											description:
												"auto = auto-correct, suggest = return suggestions only",
										},
										maxSuggestions: {
											type: "integer",
											minimum: 1,
										...
										useContextCorrection: {
											...
											default: false,
											description:
												"Use context-aware correction with surrounding words",
										},
										whitelist: {
											type: "array",
											items: { type: "string" },
											maxItems: 100,
											description:
												"Words to never correct (brand names, SKUs, etc.)",
										},
										splitCompounds: {
											type: "boolean",
											default: false,
											description:
												"Try compound word splitting (German, Finnish)",
										},
									},
								},
							},
