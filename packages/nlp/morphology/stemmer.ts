...
const RUSSIAN_SUFFIXES = [
	...
	"ейшими", "ейшего", "ейшему", "ейшими", "ейшем", "ейшая", "ейшее",
	"ейшие", "ейших", "ейшим", "ейшую", "ейше",
	"айшими", "айшего", "айшему", "айшими", "айшем", "айшая", "айшее",
	"айшие", "айших", "айшим", "айшую",
	"яйшими", "яйшего", "яйшему", "яйшими", "яйшем", "яйшая", "яйшее",
	"яйшие", "яйших", "яйшим", "яйшую",
	// Participle suffixes
	"вшимися", "вшимся", "вшемся", "вшаяся", "вшееся", "вшими",
	"нными", "нного", "нному", "нная", "нное", "нные", "нных",
	"тыми", "того", "тому", "тая", "тое", "тые", "тых",
	// Verb suffixes
	"ывали", "ивали", "ывать", "ивать",
	"овали", "овала", "овало", "овали", "овать", "овал",
	"ываю", "ывае", "ыва", "иваю", "ивае", "ива",
	"оваю", "овае", "ова",
	// Noun suffixes
	"ения", "ение", "ений", "енью", "енье",
	"ации", "ация", "аций",
	"ости", "ость",
	"теля", "тель", "телю", "телем",
	"ника", "нику", "ником", "нике",
	"ства", "ство", "ством", "стве",
	"цами", "цами", "цами",
	// Common case endings
	"ами", "ями", "его", "ему", "ими", "ыми",
	"ая", "яя", "ое", "ее", "ие", "ые",
	"ого", "его", "ому", "ему", "им", "ым",
	"ую", "юю", "ом", "ем", "ой", "ей",
	"ых", "их", "ый", "ий", "ой",
	// Short endings
	"ах", "ях", "ам", "ям", "ой", "ей",
...
export const SUPPORTED_STEMMER_LANGUAGES: StemmerLanguage[] = [
	"en", "ru", "de", "es", "fr",
];
