# AACSearch Python SDK

Python client for the [AACSearch](https://aacsearch.com) v1 REST API — search, index management, synonyms, curations, analytics, and more.
...
Use with an admin-scope API key (`aa_admin_*`) or write-scope key (`aa_write_*`).
Never bundle admin keys in browser code.
...
# Manage curations (pinned/hidden results per query)
