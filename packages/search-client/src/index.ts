...
export type {
	V2AdminClientOptions,
	V2CreateProjectInput,
	V2CreateIndexInput,
	V2UpdateIndexInput,
	V2ListDocumentsOptions,
	V2UpsertDocumentsInput,
	V2BatchDeleteInput,
	V2ExportDocumentsOptions,
	V2CreateKeyInput,
	V2CreateSynonymInput,
	V2Project,
	V2SearchIndex,
	V2SearchField,
	V2SearchRequest,
	V2Error,
} from "./v2-admin-client";
export { V2SearchClient } from "./v2-search-client";
export type {
	V2SearchClientOptions,
	V2TrackEventInput,
	V2TrackEventResult,
} from "./v2-search-client";
