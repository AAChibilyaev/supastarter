	...
	return (
		<section
			className={cn(
				...
				withBackground && variant === "secondary"
					...
					: "",
				withBackgroundGlow || imagePerspective !== "none" ? "relative overflow-hidden" : "",
		...
		>
			{effectComponent ? (
				<FadeMask
					className={cn(
						"inset-0 pointer-events-none absolute h-full w-full opacity-50",
						effectClassName,
					)}
					fadeHeight="4rem"
					aria-hidden="true"
			...
			{imageSrc && withBackgroundGlow ? (
				<div className="lg:flex pointer-events-none absolute hidden h-full w-full justify-center">
					<GlowBg
						className={cn(
							"lg:w-1/2 z-0 h-auto w-full dark:opacity-50",
			...
			<div
				className={cn(
					"p-6 gap-8 relative w-full",
					imagePosition === "center"
						? "container-narrow flex flex-col"
						: "lg:grid-cols-2 container-wide grid max-w-full items-center",
			...
			>
				...
				{imageSrc ? (
					<>
						{imagePosition === "center" ? (
							<section className={cn("mt-6 md:mt-8 w-full")}>
								<LandingImage
									className={cn(
...
export const LandingPrimaryVideoCtaSection = ({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					"p-6 gap-8 relative z-10 flex w-full flex-col",
					videoPosition === "center"
						? "container-narrow"
						: "container-wide lg:grid-cols-2 grid max-w-full items-center",
					textPosition === "center" ? "items-center" : "items-start",
					innerClassName,
				)}
				style={{
	...
	return (
		...
		>
			...
			<div
				className={cn(
					"p-6 gap-8 relative z-10 flex w-full flex-col",
					textPosition === "center" ? "container-narrow" : "container-wide max-w-full",
					textPosition === "center" ? "items-center" : "items-start",
					innerClassName,
				)}
			>
