	...
	return (
		<FormField className={props.className} id={id} name={field.name}>
			...
			<FormControl>
				...
				>
					<div className="group px-3 py-1.75 text-sm rounded-md border border-input bg-transparent ring-offset-background transition-all focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50 dark:bg-input/30">
					...
					<div className="relative">
						<CommandList ref={listRef}>
							{open && availableChoices.length > 0 ? (
								<div className="top-2 shadow-md animate-in absolute z-10 w-full rounded-md border bg-popover text-popover-foreground outline-none">
