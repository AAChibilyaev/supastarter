...
export const BulkActionsToolbar = ({
	...
	return (
		<Card className="gap-2 md:gap-6 md:flex-row sm:items-center p-2 px-4 sm:w-fit bottom-2 left-0 right-0 bg-zinc-100 dark:bg-zinc-900 fixed z-10 mx-auto flex w-[90%] flex-col items-stretch">
