...
export const ColumnsSelector = ({ children }: ColumnsSelectorProps) => {
	...
	return createPortal(
		<div>
				...
				<div className="p-1 relative">
					...
					{columnFilter && (
						<button
							...
							className="right-8 top-2 h-4 w-4 absolute text-muted-foreground"
							aria-label="Clear"
						>
							×
						</button>
			...
			<ul className="p-1 max-h-[50vh] overflow-auto">
