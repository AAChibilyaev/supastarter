...
export const ListPagination = ({
	...
	return (
		<div className={`space-x-2 gap-4 flex items-center justify-end ${className}`}>
				...
				<PaginationContent>
					<PaginationItem>
						{hasPreviousPage ? (
							...
							<span className="gap-2 text-sm font-medium size-9 inline-flex items-center justify-center whitespace-nowrap">
								<ChevronLeftIcon
									aria-label={translate("ra.navigation.previous", {
										_: "Previous",
									})}
