		...
		return (
			<SimpleFormIteratorItemBase {...props}>
				<li
					ref={ref}
					className={cn(
						"gap-2 pb-2 flex flex-row items-start justify-between border-b border-border last:border-b-0",
				...
				>
					...
					{!disabled && (
						<div className="simple-form-iterator-item-actions h-9 gap-1 flex flex-row items-center">
