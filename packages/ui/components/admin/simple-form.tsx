...
export const SimpleForm = ({
	...
	<Form className={cn(`gap-4 max-w-lg flex w-full flex-col`, className)} {...rest}>
		{children}
		{toolbar}
	</Form>
);
...
export const FormToolbar = ({ children, className, ...rest }: FormToolbarProps) => (
	<div
		{...rest}
		className={cn(
			"pt-4 pb-4 md:block md:pt-2 md:pb-0 bottom-0 sticky bg-linear-to-b from-transparent to-background to-10%",
			className,
		)}
		role="toolbar"
	>
