...
export const TextArrayInput = (props: TextArrayInputProps) => {
	...
	return (
		<FormField id={id} className={className} name={field.name}>
			...
			<FormControl>
				<div
					className="group shadow-xs px-3 py-1.75 text-sm rounded-md border border-input bg-background ring-offset-background transition-all focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50 dark:bg-input/30"
					{...rest}
				>
