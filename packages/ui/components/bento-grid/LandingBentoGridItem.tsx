...
export function LandingBentoGridItem({
	...
	const gridItemClasses = cn(
		"p-4 shadow-sm flex flex-col overflow-hidden rounded-xl border transition-all duration-200",
		...
		colSpan === 3 ? "md:col-span-2 lg:col-span-3 col-span-1" : "",
		colSpan === 4 ? "md:col-span-2 lg:col-span-4 col-span-1" : "",
	...
	const contentElement = (
		<>
			{content}
			{titleComponent ||
				(title && <h3 className="text-xl font-semibold mt-4 truncate">{title}</h3>)}
			{descriptionComponent ||
				(description && (
