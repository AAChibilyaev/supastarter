...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"group/calendar p-3 bg-background [--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
			...
			classNames={{
				...
				button_previous: cn(
					...
					"p-0 h-[--cell-size] w-[--cell-size] select-none aria-disabled:opacity-50",
				...
				dropdown: cn("inset-0 absolute bg-popover opacity-0", defaultClassNames.dropdown),
				caption_label: cn(
					"font-medium select-none",
					captionLayout === "label"
						? "text-sm"
						: "h-8 gap-1 pl-2 pr-1 text-sm [&>svg]:size-3.5 flex items-center rounded-md [&>svg]:text-muted-foreground",
