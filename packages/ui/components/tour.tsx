				...
				{currentStep >= 0 && elementPosition && (
					<>
						<motion.svg
							...
							animate={{ opacity: 1 }}
							exit={{ opacity: 0 }}
							className="inset-0 pointer-events-auto fixed z-50 h-full w-full"
						>
							<defs>
								<mask id="tour-mask">
						...
						<motion.div
							...
							className="p-4 shadow-lg relative z-[100] rounded-lg border bg-background"
						>
							<div className="right-4 top-4 gap-2 absolute z-10 flex items-center">
								...
								{isCloseable && (
									<button
										...
										className="h-6 w-6 inline-flex items-center justify-center rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none"
									>
										<X className="h-4 w-4" />
