...
const translations: Record<string, Record<string, string>> = {
	...
	ru: {
		...
		recommendationsLoading: "Загрузка рекомендаций...",
		noRecommendations: "Рекомендации не найдены",
		recommendationsError: "Ошибка загрузки рекомендаций",
		close: "Закрыть",
	},
	de: {
		...
		recommendationsLoading: "Empfehlungen werden geladen...",
		noRecommendations: "Keine Empfehlungen gefunden",
		recommendationsError: "Fehler beim Laden der Empfehlungen",
		close: "Schließen",
	},
	es: {
		...
		recommendationsError: "Error al cargar recomendaciones",
		close: "Cerrar",
	},
	fr: {
		...
		recommendationsLoading: "Chargement des recommandations...",
		noRecommendations: "Aucune recommandation trouvée",
		recommendationsError: "Échec du chargement des recommandations",
		close: "Fermer",
	},
};
